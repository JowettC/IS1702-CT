...
# ewby = employee with birth year
ewby = read_file_2b("./content/employees_birthyear_1mil.csv")
ewby = perform_once_2b(ewby)  # does nothing for now
# Test case lab2(b)_1
# birth year: 1949. IDs: [101, 201, 1999632, 1999649]
...
if sorted(result) == [101, 201, 1999632, 1999649]:
  ...
  print("failed: Test case 1 failed.")
